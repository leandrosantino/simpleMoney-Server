/*
  ...
  - Added the required column `description` to the `CardExpense` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_CardExpense" ("accountId", "cardId", "categoryId", "date", "frequency", "id", "ignore", "invoiceDate", "repeatId", "userId", "value") SELECT "accountId", "cardId", "categoryId", "date", "frequency", "id", "ignore", "invoiceDate", "repeatId", "userId", "value" FROM "CardExpense";

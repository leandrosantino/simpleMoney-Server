/*
  ...
  - You are about to drop the column `accountId` on the `CardExpense` table. All the data in the column will be lost.
...
INSERT INTO "new_CardExpense" ("cardId", "categoryId", "date", "description", "frequency", "id", "ignore", "invoiceDate", "repeatId", "userId", "value") SELECT "cardId", "categoryId", "date", "description", "frequency", "id", "ignore", "invoiceDate", "repeatId", "userId", "value" FROM "CardExpense";
